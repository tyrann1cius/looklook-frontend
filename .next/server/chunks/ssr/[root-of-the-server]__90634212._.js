...
"[project]/src/app/utils/jwt.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function parseAuthCookie(cookieHeader) {
    ...
    const cookies = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cookie$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Cookie"].parse(cookieHeader);
    return cookies.authToken || null;
}
function verifyJwt(token) {
    try {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].verify(token, process.env.JWT_SECRET);
    } catch (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$jwt$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/utils/jwt.ts [app-rsc] (ecmascript)");
;
;
;
;
...
async function PromoPage() {
    ...
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$jwt$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseAuthCookie"])(Headers.get('cookie'));
    const payload = token ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$jwt$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyJwt"])(token) : null;
    if (!payload) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/login', request.url));
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__90634212._.js.map